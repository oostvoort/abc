...
library Counter {
  ...
  /** Get value */
  function get(bytes32 playerId, uint8 index) internal view returns (uint32 value) {
  ...
  function get(IStore _store, bytes32 playerId, uint8 index) internal view returns (uint32 value) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = playerId;
    _keyTuple[1] = bytes32(uint256(index));
  ...
  /** Set value */
  function set(bytes32 playerId, uint8 index, uint32 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = playerId;
    _keyTuple[1] = bytes32(uint256(index));
  ...
  function set(IStore _store, bytes32 playerId, uint8 index, uint32 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = playerId;
    _keyTuple[1] = bytes32(uint256(index));
