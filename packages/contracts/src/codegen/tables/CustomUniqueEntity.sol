...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("CustomUniqueEnti")));
bytes32 constant CustomUniqueEntityTableId = _tableId;

library CustomUniqueEntity {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("CustomUniqueEntity", _fieldNames);
  }
