...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("TeamItem")));
bytes32 constant TeamItemTableId = _tableId;
...
library TeamItem {
  ...
  /** Get value */
  function get(bytes32 playerId, uint8 index) internal view returns (bytes32 value) {
  ...
  function get(IStore _store, bytes32 playerId, uint8 index) internal view returns (bytes32 value) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = playerId;
    _keyTuple[1] = bytes32(uint256(index));
  ...
  /** Set value */
  function set(bytes32 playerId, uint8 index, bytes32 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = playerId;
    _keyTuple[1] = bytes32(uint256(index));
  ...
  function set(IStore _store, bytes32 playerId, uint8 index, bytes32 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = playerId;
    _keyTuple[1] = bytes32(uint256(index));
